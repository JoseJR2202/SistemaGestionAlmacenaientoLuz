...
export declare const searchProyectFieldsValidation: import("express-validator").ValidationChain[];
export declare const searchMettingFieldsValidation: import("express-validator").ValidationChain[];
