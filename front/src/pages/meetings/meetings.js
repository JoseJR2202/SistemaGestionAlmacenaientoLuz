...
const Meetings = () => {
  ...
  const [searchMeeting, setSearchhMeeting] = useState([
    { id: 0, titulo: '', extra: '' },
  ]);
  ...
  return (
    ...
    >
      ...
      <br />
      <Forms
        jsonfield={fieldSearchMetting}
        jsonform={jsonSearchMetting}
        jsonValidation={schemaSearchMetting}
        submit={submitFilterMeeting}
      />
      <br />
      <Row className='justify-content-center'>
        <Table
          ...
          onClickButton={(row) => {
            navigate(`/reuniones/detail/${row.original.id}`);
          }}
        />
      </Row>
      <br />
